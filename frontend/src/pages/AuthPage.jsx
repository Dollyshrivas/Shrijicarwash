  ...
  return (
    <main className="min-h-screen bg-[#f8f8f8] px-4 py-12 flex items-center justify-center">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {mode === "signup" && (
            <input
              ...
              className="p-3 rounded-lg border border-gray-300 text-gray-900 outline-none focus:border-[#d00000]"
            />
          )}
          <input
            name="email"
          ...
          <button
            ...
            className="py-3 rounded-lg bg-black text-white font-bold hover:bg-[#d00000] transition disabled:opacity-60"
          >
            {isSubmitting
              ? "Please wait..."
              : mode === "login"
        ...
        <Link
          to="/"
          className="block text-center text-gray-500 hover:text-[#d00000] mt-6"
        >
          Back to home
        </Link>
      </div>
